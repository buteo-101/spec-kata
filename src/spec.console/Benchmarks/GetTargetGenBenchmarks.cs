...
namespace SpecConsole.Benchmarks
{
    ...
    public class GetTargetGenBenchmarks
    {
        ...
        private static readonly SpeciesNestedCalculator _nestedCalculator = new SpeciesNestedCalculator();
        ...
        public void GetInnerClocksForGenerationWithMutations()
        {
            ...
            Console.WriteLine($"start of the array Mutations  {JsonSerializer.Serialize(computedGen.Take(10))}");
            Console.WriteLine($"array length {computedGen.Count}");
        }

        [Benchmark]
        public void GetInnerClocksForGenerationWithNested()
        {
            ...
            var computedGen = _nestedCalculator.GetInnerClocksForGeneration(InnerClocksList, 18);
  
            Console.WriteLine($"start of the array Nested {JsonSerializer.Serialize(computedGen.Take(10))}");
            Console.WriteLine($"array length {computedGen.Count}");
        }
